...
```
Coefficient of variation 0f Numbathrooms is the closest to the Coefficient of variation of sqft. Also, the value of r = 0.7 which is greater than o.5. We also saw the variance of auxiliary variable Numbathrooms is the smallest. From the plots, we can see the  correlation coefficient between Numbathrooms and Sqft is highest (greater than o.5). So, Numbathroorms must be the better choice for ratio estimator
