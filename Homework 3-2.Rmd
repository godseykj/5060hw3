...
```
 I think the relationship between  the auxilary variable Yearbuilt and Sqft is highly unlikely to go through the origin and regression estimator is the best choice.