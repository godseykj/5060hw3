...
Coefficient of variation 0f Numbathrooms is the closest to the Coefficient of variation of sqft. Also, the value of r = 0.7 which is greater than o.5. So, It must be the better choice for ratio estimator
```{r}
